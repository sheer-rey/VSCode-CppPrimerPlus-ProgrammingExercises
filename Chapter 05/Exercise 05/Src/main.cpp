...
int main()
{
    ...
    int iNumberofCars_7;
    (cin >> iNumberofCars_7).get();
    car_7 *pUserCars_7 = new car_7[iNumberofCars_7];
    for (int i = 0; i < iNumberofCars_7; i++)
    {
        cout << "Car #" << i + 1 << ": " << endl;
        cout << "Please enter the manufacturer: ";
        getline(cin, pUserCars_7[i].strManufacturer);
        cout << "Please enter the year of manufacture: ";
        cin >> pUserCars_7[i].iProductiveYear;
        cin.get();
    }
    cout << "Here is your collection: " << endl;
    for (int i = 0; i < iNumberofCars_7; i++)
        cout << pUserCars_7[i].iProductiveYear << " " << pUserCars_7[i].strManufacturer << endl;
    ...
    char cWords_8[20] = {};
    int iNumberofWords_8 = 0;
    cout << "Enter words (to stop, type the word \"done\") : " << endl;
    cin >> cWords_8;
    while (strcmp(cWords_8, "done") != 0)
    {
        iNumberofWords_8++;
        cin >> cWords_8;
    }
    cin.get();
    cout << "You entered a total of " << iNumberofWords_8 << " words." << endl;
    ...
    string strWords_9;
    int iNumberofWords_9 = 0;
    cout << "Enter words (to stop, type the word \"done\") : " << endl;
    cin >> strWords_9;
    while (strWords_9 != "done")
    {
        iNumberofWords_9++;
        cin >> strWords_9;
    }
    cin.get();
    cout << "You entered a total of " << iNumberofWords_9 << " words." << endl;
    ...
    int iNumberofRows_10;
    cin >> iNumberofRows_10;
    for (int i = 0; i < iNumberofRows_10; i++)
    {
        for (int j = 0; j < iNumberofRows_10; j++)
        {
            if (iNumberofRows_10 - j - 1 <= i)
                cout << "*";
            else
                cout << ".";
        }
